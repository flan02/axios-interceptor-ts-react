...
// ! Manejamos el error con useState, pero por cada error que se presente, tendremos que crear un nuevo estado. BAD PRACTICE !!!
// ? Podemos usar Context para manejar con una variable el error, pero no es la mejor opción se complica demasiado.
